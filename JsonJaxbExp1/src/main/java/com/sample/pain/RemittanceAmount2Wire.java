...
@XmlType(name = "RemittanceAmount2Wire", propOrder = {
    "duePyblAmt",
    "dscntApldAmt",
    "cdtNoteAmt",
    "taxAmt",
...
public class RemittanceAmount2Wire {
    ...
    protected List<DocumentAdjustment1Wire> adjstmntAmtAndRsn;
     ...
     * 
     */
    public List<DocumentAdjustment1Wire> getAdjstmntAmtAndRsn() {
        if (adjstmntAmtAndRsn == null) {
            adjstmntAmtAndRsn = new ArrayList<DocumentAdjustment1Wire>();
        }
